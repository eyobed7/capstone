...
SECRET_KEY = 'django-insecure-5v8vk^d_g94w&u4ho_+b&gb!4niwl-%g8wu@ro=0b+^ucv683='
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.permissions.IsAuthenticatedOrReadOnly',  # General permission class
    ],
}
...
AUTHENTICATION_BACKENDS = [
    'app.backends.EmailBackend',  # Custom email backend
