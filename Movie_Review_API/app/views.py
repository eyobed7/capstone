...
from userprofile.forms import ProfileForm  # Assuming you've created a form for the Profile model
from userprofile.models import Profile
from reviewcomment.models import ReviewComment
from reviewcomment.serializers import ReviewCommentSerializer
from .serializers import fetch_movie_details
...
def most_reviewed_movies_view(request):
    ...
    return render(request, 'most_reviewed_movies.html', {'most_reviewed_movies': most_reviewed_movies})
...
def update_profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('review-list')  # Redirect to the profile page (you need to set up the URL for 'profile')
    else:
...
def register_user(request):
    if request.method == 'POST':
        ...
        if serializer.is_valid():
            ...
            return redirect('review-create')  # Use the reviews route defined in the router
